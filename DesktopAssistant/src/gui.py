...
speak_button = tk.Button(master=root,image=circ,command=lambda: None,borderwidth=0)
entry = tk.Entry(root)
# Display image
...
chat_listbox = tk.Listbox(master=canvas1, height=20, width=50)
...
chat_listbox.pack(side=tk.RIGHT)
